...
public class Sportcategorie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sportcategorie);
        ...
        school.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sportcategorie.this,AnnonceCategorisee.class);
        ...
        sport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sportcategorie.this,Sportcategorie.class);
                startActivity(intent);
            }
        });
        //pour meuble
        ...
        meuble.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sportcategorie.this,Meuble.class);
                startActivity(intent);
            }
        });
        //pour vaisselle
        ...
        vaisselle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sportcategorie.this,Vaisselle.class);
                startActivity(intent);
            }
        });
        //pour divertissement
        ...
        divertissement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sportcategorie.this,Divertissement.class);
                startActivity(intent);
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView1.setAdapter(new AdaptAnnocaCategorie(myItemsList,Sportcategorie.this));
            }
        ...
        butt.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_home:
                    Intent intent = new Intent(Sportcategorie.this,Home.class);
                    startActivity(intent);
                    return true;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sportcategorie.this,AjoutProduit.class));
            }
        });
    }
}