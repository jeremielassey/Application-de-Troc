...
public class Vaisselle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vaisselle);
        ...
        school.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Vaisselle.this,AnnonceCategorisee.class);
        ...
        sport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vaisselle.this,Sportcategorie.class);
                startActivity(intent);
            }
        });
        //pour meuble
        ...
        meuble.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vaisselle.this,Meuble.class);
                startActivity(intent);
            }
        });
        //pour vaisselle
        ...
        vaisselle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vaisselle.this,Vaisselle.class);
                startActivity(intent);
            }
        });
        //pour divertissement
        ...
        divertissement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vaisselle.this,Divertissement.class);
                startActivity(intent);
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot Produits : snapshot.child("Produits").getChildren()){
                    for(DataSnapshot elemnt : Produits.getChildren()){
                        ...
                        MyItems myItems = new MyItems(getcategorie,getdescrip, getImage, getnom_produit, getdate,"ee");
                        if (getcategorie != null && getcategorie.equals("Vaiselle")) {
                ...
                recyclerView1.setAdapter(new AdaptAnnocaCategorie(myItemsList,Vaisselle.this));
            }
        ...
        butt.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_home:
                    Intent intent = new Intent(Vaisselle.this,Home.class);
                    startActivity(intent);
                    return true;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Vaisselle.this,AjoutProduit.class));
            }
        });
    }
}